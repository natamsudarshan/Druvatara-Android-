...
class ChildRequestList extends StatelessWidget {
  const ChildRequestList({super.key});
  ...
  Widget build(BuildContext context) {
    ...
    return ListView.builder(
      ...
      itemBuilder: (context, index) {
        ...
        return _ChildRequestCard(request: request);
      },
    );
  }
}

class _ChildRequestCard extends StatelessWidget {
  final Map<String, dynamic> request;

  const _ChildRequestCard({required this.request});
